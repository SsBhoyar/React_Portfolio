...
const Footer = () => {
  return (
    <footer className=" px-10 md:px-0 py-10 bg-amber-100 dark:bg-neutral-900">
      <div className="flex items-center space-x-6">
        {/* <a href="#" className="text-blue-500">
          <img src={LOGO} className="w-10 md:w-12 lg:1-16 inline mr-3" alt="Swastik" />
          <span className="text-2xl font-bold text-orange-500 dark:text-amber-400">
            Swastik
          </span>
        </a> */}
      </div>
      ...
      <div className="mt-8">
        {/* <ul className="bg-slate-400 flex flex-col space-y-4 md:space-y-0 md:flex-row md:space-x-6 lg:space-x-12 md:items-center font-semibold text-base text-gray-700 dark:text-gray-100"> */}
        <ul className=" md:space-x-4 md:text-center">
          <li
            className="p-2 text-center font-semibold text-gray-600  md:text-left md:text-lg md:px-4 my-1 transition duration-200 hover:scale-105 hover:bg-gradient-to-br hover:from-orange-300 hover:to-amber-300 bg-amber-200 rounded-lg md:inline-block
            focus:outline-2 focus:outline-red-200"
          >
            <a href="#" className="focus:outline-none">
              About us
            </a>
          </li>
          <li className="p-2 text-center font-semibold text-gray-600 md:text-left md:text-lg md:px-4 my-2 transition duration-200 hover:scale-105 hover:bg-gradient-to-br hover:from-orange-300 hover:to-amber-300 bg-amber-200 rounded-lg md:inline-block">
            <a href="#" className="focus:outline-none">
              Company History
            </a>
          </li>
          ...
          <li className="p-2 text-center font-semibold text-gray-600 md:text-left md:text-lg md:px-4 my-2 transition duration-200 hover:scale-105 hover:bg-gradient-to-br hover:from-orange-300 hover:to-rose-300 bg-amber-200 rounded-lg md:inline-block">
            <a href="#" className="focus:outline-none">
              Press Release
            </a>
          </li>
      ...
      <p className="text-center font-semibold my-4 text-gray-700">
